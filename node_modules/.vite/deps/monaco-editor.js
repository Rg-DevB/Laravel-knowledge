...
import { a as MarkerSeverity, c as Range, d as Token, f as Uri, h as languages, i as KeyMod, l as Selection, m as editor_api2_exports, n as Emitter, o as MarkerTag, p as editor, r as KeyCode, s as Position, t as CancellationTokenSource, u as SelectionDirection } from "./editor.api2-b0UN5qnx.js";
import { t as monaco_contribution_exports$3 } from "./monaco.contribution-DJ0iPICM.js";
import { t as createWebWorker } from "./workers--2LuLks_.js";
import "/workspace/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon.css";
import "/workspace/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon-modifiers.css";
...
function getMode$2() {
	return import("./cssMode-BquN-RjD.js");
}
...
function getMode$1() {
	return import("./htmlMode-Qq6vwfzt.js");
}
...
function getMode() {
	return import("./jsonMode-DKUIoo9L.js");
}
languages.register({
	id: "json",
	extensions: [
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BJxOes_t.js").then((m) => m.TagAutoInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BJxOes_t.js").then((m) => m.TagAngleInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BJxOes_t.js").then((m) => m.TagBracketInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BJxOes_t.js").then((m) => m.TagAngleInterpolationBracket);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BJxOes_t.js").then((m) => m.TagBracketInterpolationBracket);
	}
});
registerLanguage({
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BJxOes_t.js").then((m) => m.TagAutoInterpolationBracket);
	}
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./handlebars-BZTqB5BO.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./html-BWh5jFvk.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./javascript-BH2sGpBt.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./liquid-P_aX3UnZ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./python-bjXm2FnQ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./razor-C9ZGBKHa.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./twig-CS8V2xqc.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./typescript-CXgmtzlW.js");
	}
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./yaml-DnVvokMD.js")
});
//#endregion
