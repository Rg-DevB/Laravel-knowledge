    ...
    <div class="grid lg:grid-cols-2 gap-6">
        <div>
            ...
            <div class="space-y-2">
                ...
                @empty
                <p class="text-xs text-zinc-600 text-center py-6">No problems yet.</p>
                @endforelse
            </div>
        </div>
    ...
    <div class="space-y-2">
        ...
        <div class="flex items-start gap-4 p-4 rounded-xl border border-zinc-800/60 bg-zinc-900/30 hover:bg-zinc-900/60 transition-all">
            ...
            <div class="flex-1 min-w-0">
                <a href="{{ route('problems.show', $problem->slug) }}" wire:navigate class="text-sm font-medium text-zinc-200 hover:text-white transition-colors line-clamp-1">{{ $problem->title }}</a>
